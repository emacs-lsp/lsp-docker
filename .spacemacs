...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(scala-mode php-mode company-posframe kotlin-mode vue-mode)
...
before packages are loaded."
  ;; make the treemacs icons smaller
  ...
  (spacemacs|define-jump-handlers nxml-mode)
